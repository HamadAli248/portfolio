          ...
          <Cell className="aboutme-right-col" col={8}>
            ...
            <div id="aboutme-div">
              ...
              <p>
                ...
                <a href="https://www.dmwgroup.com/">DMW Group</a>. Completed the
                first 12-week training at Code Nation, Manchester. Learning
                Front-End development including HTML5, CSS3, JavaScript, React,
                Back-End programming such as APIs, Node.JS, Mongo. DB, MySQL,
                Express, iOS Swift programming and using the terminal and
                command line,and using git hub. I've have also been learning
                Java and looking into Databases(PostgreSQL),Spring Boot and
                finally AWS.
                <br />
